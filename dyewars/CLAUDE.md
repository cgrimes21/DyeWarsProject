...
**Note:** Server OpCodes.h is the single source of truth. Keep PacketOpcodes.cs in sync.
...
| 0x25 S_Player_Spatial (Batch) | HandleBatchPlayerSpatial | RemotePlayerUpdateEvent (per player) | PlayerRegistry, PlayerViewFactory |
| 0x26 S_Left_Game | HandlePlayerLeft | PlayerLeftEvent | PlayerRegistry, PlayerViewFactory |
| 0xF2 S_ServerShutdown | HandleServerShutdown | DisconnectedFromServerEvent | UI |
| 0xF8 S_Ping_Request | HandleServerPingRequest | (sends C_Pong_Response) | - |
...
| 0xF9 C_Pong_Response | SendPongResponse() |
